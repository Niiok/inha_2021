...
//
//
//Geometry::CRect::CRect() : CGeometry()
//{
//}
//Geometry::CRect::CRect(int x, int y) : CGeometry(x, y)
//{
//	radius_ = (rand() % 90) + 10;
//}
//Geometry::CRect::~CRect()
//{
//
//}
//
//void Geometry::CRect::Collision(std::vector<Geometry::CGeometry*>& list)
//{
//
//	// other object
//	for (auto i : list)
...
//
//
//double Geometry::CRect::OverlapWith(Geometry::CGeometry* another) const
//{
//	CRect* cp = dynamic_cast<CRect*>(another);
//	if (cp != NULL)
...
//	return -1;
//}
//double Geometry::CRect::OverlapWith(const Geometry::CRect* another) const
//{
...
//}
//
//double Geometry::CRect::CollideWith(Geometry::CGeometry* another)
//{
//	CRect* cp = dynamic_cast<CRect*>(another);
//	if (cp != NULL)
...
//	return -1;
//}
//double Geometry::CRect::CollideWith(Geometry::CRect* another)
//{
...
//}
//
//float Geometry::CRect::MaxDistance() const
//{
//	return sqrtf(height_*height_ + width_*width_);
//}